    ...
    <main className="landing">
      ...
      <section className="strip">
        <div className="strip__item">
          <span className="strip__number">12,800+</span>
          <span className="strip__label">Contracts completed</span>
        </div>
        <div className="strip__item">
          <span className="strip__number">$8.4M</span>
          <span className="strip__label">Paid out to freelancers</span>
        </div>
        <div className="strip__item">
          <span className="strip__number">2.1 days</span>
          <span className="strip__label">Average time to payment</span>
        </div>
      </section> */}

      <section className="cta-banner" id="pricing">
        <h2>Set up your first contract in minutes.</h2>
        <p>Free for your first three active projects. No credit card needed.</p>
        <Link to="/register" className="btn btn-primary">Create your account</Link>
      </section>
